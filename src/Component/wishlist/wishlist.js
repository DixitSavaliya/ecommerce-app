...
import { MDBContainer, MDBCard, MDBCardBody, MDBRow, MDBCardTitle, MDBCol } from 'mdbreact';
            ...
            <div key={index}>
                <MDBRow>
                        ...
                        <div>
                            ...
                            {(data.productImage) ?
                                (<div  className="img_height">
                                    {data.productImage.containerName ? (<img alt="products"  src={config.baseMediaUrl + data.productImage.containerName + data.productImage.image} className="img-fluid" />) : (<img  alt="products" src={config.baseMediaUrl + data.productImage.image} className="img-fluid" />)}
                                </div>) : ('')}
                       
                        </div>
                    </MDBCol>
                    <MDBCol md="2"><Link to={`/singleproduct/${data.productId}`}>{data.product.name}</Link></MDBCol>
                    <MDBCol md="2"><i className="fas fa-rupee-sign"></i> {data.product.price}</MDBCol>
                    ...
                    <MDBCol md="2">
                        ...
                        <i className="fas fa-trash" onClick={() => this.deleteWishList(data._id)}></i>
                    </MDBCol>
