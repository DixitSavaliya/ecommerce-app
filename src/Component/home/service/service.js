                        ...
                        <div className="row m-0">
                            <div className="col-md-4" data-aos="zoom-in" data-aos-duration="1500">
                                <div className="service_content">
                                    <div className="icon">
                                        {/* <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512; fill: white;" height="36px" width="36px" xml:space="preserve">
								<g>
                            ...
                            <div className="col-md-4" data-aos="zoom-in" data-aos-duration="1500">
                                <div className="service_content">
                                    <div className="icon">
                                        {/* <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 66.915 66.915" style="enable-background:new 0 0 66.915 66.915; fill: white;" height="36px" width="36px" xml:space="preserve">
								<g>
                            ...
                            <div className="col-md-4" data-aos="zoom-in" data-aos-duration="1500">
                                <div className="service_content">
                                    <div className="icon">
                                        {/* <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512.076 512.076" style="enable-background:new 0 0 512.076 512.076;fill: white" height="36px" width="36px" xml:space="preserve">
